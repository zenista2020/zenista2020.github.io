...
{
    $("#imageIntro").hide();
    // In cellphones a video can't possibly be played, so we'll substitute it with a photo background
    $("#videoContainer").removeClass("mobile-background");
}



// This code will center your video once the page loads or the window's resized
